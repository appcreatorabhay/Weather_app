...
import 'package:weather_app/secrets_dart.dart';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: getCurrentWeather(widget.city),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return HourlyForecastItem(
                        ...
                        icon: data['list'][index + 1]['weather'][0]['main'] ==
                            'CLouds' || data['list'][index + 1]['weather'][0]['main'] ==
                            'Rain' ? Icons.cloud : Icons.sunny,
                        label1: data['list'][index + 1]['main']['temp'].toString(),
                      );
                    },
                  ),
                ),
